...
const ROLES = ["Full Stack Developer", "Blockchain Engineer", "Problem Solver", "CS Student @ GEHU", "React Developer"];
        ...
        <ul style={{ margin: "16px 0 0", paddingLeft: 0, listStyle: "none" }}>
          {p.points.map((pt, i) => (
            <li key={i} style={{ display: "flex", gap: 10, marginBottom: 8, fontSize: 13, color: "#c9d1d9", lineHeight: 1.6 }}>
              <span style={{ color: p.grad[1], marginTop: 2, flexShrink: 0 }}>▸</span>
              {pt}
            </li>
          ))}
        </ul>
  ...
  useEffect(() => {
    ...
    style.textContent = `
      *{box-sizing:border-box;margin:0;padding:0}
      ...
      body{font-family:'Segoe UI',system-ui,sans-serif;background:#010409;color:#c9d1d9;overflow-x:hidden}
      ...
      input,textarea{background:#0d1117;border:1px solid #30363d;color:#c9d1d9;border-radius:10px;padding:11px 14px;font-size:14px;font-family:inherit;width:100%;outline:none;transition:border 0.2s}
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#010409" }}>
      ...
      <div style={{
        ...
        background: scrolled ? "rgba(1,4,9,0.92)" : "transparent",
        ...
        <div style={{ fontWeight: 800, fontSize: 20, letterSpacing: -1 }}>
          ...
          <span style={{ color: "#e6edf3", marginLeft: 2 }}>.</span>
        </div>
      ...
      <section id="Home" style={{ minHeight: "100vh", display: "flex", alignItems: "center", position: "relative", overflow: "hidden", paddingTop: 64 }}>
        ...
        <div className="section-inner" style={{ display: "flex", alignItems: "center", gap: 60, position: "relative", zIndex: 1 }}>
          <div className="fade-in" style={{ flex: 1 }}>
            ...
            <div style={{ display: "flex", gap: 14, flexWrap: "wrap", marginBottom: 48 }}>
              ...
              <a href="mailto:knegi4394@gmail.com" style={{
                ...
                onMouseEnter={e => { e.currentTarget.style.background = "#1d9e7514"; e.currentTarget.style.borderColor = "#1d9e75"; }}
                onMouseLeave={e => { e.currentTarget.style.background = "none"; e.currentTarget.style.borderColor = "#1d9e7555"; }}
              >📬 Hire Me</a>
              <a href="https://github.com/krishnanegi-06" target="_blank" rel="noreferrer" style={{
          ...
          {/* Avatar */}
          <div className="float" style={{ flexShrink: 0, position: "relative" }}>
            <div style={{
              width: 260, height: 260, borderRadius: "50%",
              background: "linear-gradient(135deg, #0d1117, #161b22)",
              border: "2px solid #1d9e7544",
              display: "flex", alignItems: "center", justifyContent: "center",
              fontSize: 100, position: "relative",
              boxShadow: "0 0 60px #1d9e7522, 0 0 120px #1d9e7511",
            }}>
              <div style={{
                position: "absolute", inset: -2, borderRadius: "50%",
                background: "conic-gradient(from 0deg, #1d9e75, #5dcaa5, transparent, transparent, #1d9e75)",
                animation: "spin 6s linear infinite", zIndex: -1,
              }} />
              👨‍💻
            </div>
            {/* floating badges */}
            {[
              ...
              { t: "Solidity", x: 210, y: 40, c: "#a8b0d6" },
              { t: "Node.js", x: 200, y: 180, c: "#5fa04e" },
              { t: "DSA", x: -55, y: 190, c: "#ef9f27" },
            ].map(b => (
              <div key={b.t} style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, marginBottom: 48 }}>
            {[
              ...
              <div key={exp.role} style={{
                ...
                onMouseEnter={e => e.currentTarget.style.borderColor = exp.col}
                onMouseLeave={e => e.currentTarget.style.borderColor = "#21262d"}
              >
      ...
      {/* ── FOOTER ── */}
      <footer style={{ background: "#010409", borderTop: "1px solid #21262d", padding: "24px 5vw", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
